...
<script src="{{asset('assets')}}/admin/plugins/perfect-scrollbar.min.js"></script>
<script src="{{asset('assets')}}/admin/plugins/smooth-scrollbar.min.js"></script>
<script src="{{asset('assets')}}/admin/plugins/chartjs.min.js"></script>
<script>
