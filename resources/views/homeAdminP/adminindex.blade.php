...
@section('content')
    <!--==============================this is the main content of the admin=================================-->
                ...
                <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
                    ...
                    <ul class="navbar-nav  justify-content-end">
                        <li class="nav-item d-flex align-items-center">
                            <a href="/logoutuser" class="nav-link text-body font-weight-bold px-0">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                <div>
                                                    <img
                                                        src="{{asset('assets')}}/admin/img/small-logos/logo-atlassian.svg"
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                <div>
                                                    <img
                                                        src="{{asset('assets')}}/admin/img/small-logos/logo-spotify.svg"
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                <div>
                                                    <img
                                                        src="{{asset('assets')}}/admin/img/small-logos/logo-invision.svg"
